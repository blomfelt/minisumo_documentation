...
To make a new page run the command `hugo new docs/example-page.md` to create the page "Example-page". Then push the changes as above to update the site. 

To see your changes before they are pushed you may use the `hugo server` command.
